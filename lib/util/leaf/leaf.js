...
function leaf(obj, path, value, opts = {}) {
  ...
  setLeafValue = setLeafValue || (defaults.leafValue && isFunction(defaults.leafValue.select)) ? defaults.leafValue.select(opts) : error('Missing leafValue.select in defaults', defaults)
